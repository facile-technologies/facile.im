        ...
        >
          ...
          <div className="space-y-6">
            <div className="relative">
              <label className="absolute -top-3 left-5 px-1 font-[12px] !text-[#DADADA] !dark:text-[#DADADA] bg-[#F5F5F5] dark:bg-[#262626]">
                {platform?.id ? ` ${platform?.name}` : `${platform?.name}`}{" "} Username / URL
              </label>
              <input
                type="text"
                placeholder=""
                ...
                className="w-full rounded-full border border-[#5A5A5A] dark:border-[#EAECF0] bg-transparent text-black dark:text-white px-5 py-3 text-sm outline-none"
                autoFocus
              />
              {username.trim() && (
