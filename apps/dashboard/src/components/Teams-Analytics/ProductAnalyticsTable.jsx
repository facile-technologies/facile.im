        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody>
            {products.length === 0 ? (
              ...
              <tr key={product.product_id} className="group hover:bg-[#ffffff05] transition-colors border-b border-[#ffffff05] last:border-0">
                <td className="p-6">
                ...
                <td className="p-6 text-right font-medium text-black dark:text-white">${Number(product.earnings).toFixed(2)}</td>
              </tr>
            ))}
          </tbody>
        </table>
