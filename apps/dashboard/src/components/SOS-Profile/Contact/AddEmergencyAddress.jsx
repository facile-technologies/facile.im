      ...
      >
        ...
        <div className="flex flex-col gap-0 mb-5">
          <h2 className="text-black dark:text-white text-lg font-semibold ">
            {contactInfo && contactInfo.id ? "Edit Address" : "Add Address"}
          </h2>
          <p className="text-[12px]  opacity-50">
            Provide the address of the person who should be notified when you’re
            in trouble.
          </p>
        </div>
        ...
        <div className="flex justify-end gap-3 mt-8">
          ...
          >
            {contactInfo && contactInfo.id ? "Update" : "Add Address"}
          </button>
        </div>
      </DialogContent>
    </Dialog>
