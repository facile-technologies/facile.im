...
export default function SosLivePreview() {
  ...
  const layoutType = useSelector(
    (state) => state.sosprofile.customization?.layout
  );
  ...
  const contactBtnEnabled = useSelector(
    (state) => state.sosprofile.ContactCustomization?.contactBtnEnabled ?? true
  );
  ...
  const mediacltitle = useSelector(
    (state) => state.sosprofile.medicaCustomization?.headerText
  );
  ...
  return (
    <div className="flex flex-col gap-4 w-auto mx-auto p-4 shrink-0">
      ...
      <div className="flex items-center justify-between px-2 w-full lg:w-[375px]">
        ...
        <a
          href={profile.username ? `/sos/${profile.username}` : "#"}
          target="_blank"
      ...
      <div className="relative">
        ...
        visibleAddresses.length > 0 ? (
                  ...
                  visibleEmergencyContacts.map((contact, index) => (
                    ...
                    >
                      ...
                      <div className="flex gap-2">
                        ...
                        {contactBtnEnabled && (
                          <a type="button" className="text-white">
                            <img src={WhatsAppIcon} alt="WhatsApp" className="w-6 h-6" /> {/* WhatsApp icon */}
                          </a>
                        )}
                      </div>
                    </div>
          ...
          <div className="w-full mb-4">
            <div className="border-2 border-dashed border-white rounded-2xl p-12 text-center">
        ...
        <div className="w-full flex flex-col items-start">
          <div className="space-y-2 w-full mb-2 rounded-2xl">
            {mediaclInfo && mediaclInfo?.length > 0 ? (
              ...
              <div className="w-full mb-4">
                <div className="border-2 border-dashed border-white rounded-2xl p-10 text-center">
            ...
            {insurancesCompanyName || insurancesID ? (
              <>
                <div className="w-full flex flex-col items-start">
                  ...
                  <div
                    className="flex w-full items-center justify-between p-4 rounded-2xl mt-2"
                    style={{ backgroundColor: medicalcardBg }}
                  >
                    <div className="flex flex-col items-start">
